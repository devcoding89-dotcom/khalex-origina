        ...
        <section className="relative h-[350px] md:h-[400px] flex items-center justify-center overflow-hidden">
          ...
          <div className="container mx-auto px-4 relative z-20 text-center space-y-4">
            ...
            <h2 className="text-3xl md:text-4xl font-black uppercase italic tracking-tighter leading-none">
              Featured <span className="text-secondary neon-text">Product</span>
            </h2>
            <div className="max-w-md mx-auto">
              <h3 className="text-base md:text-lg font-black uppercase tracking-tight text-white mb-1">{videoProduct.name}</h3>
              <p className="text-[9px] text-muted-foreground uppercase font-bold tracking-widest italic">{videoProduct.description}</p>
            </div>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Link href={`/products/${videoProduct.id}`}>
                <Button size="lg" className="h-10 px-8 bg-secondary text-secondary-foreground hover:bg-secondary/90 font-black uppercase text-[10px] rounded-none">
                  Buy Now
                </Button>
              </Link>
            </div>
      ...
      <section className="py-12 bg-card/30 border-y border-white/5">
        <div className="container mx-auto px-4">
          <div className="flex justify-between items-end mb-8">
            <div>
              <h2 className="text-xl font-black italic tracking-tighter uppercase mb-1">Featured Gear</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {featuredProducts.length > 0 ? (
              ...
              <div className="col-span-full py-20 text-center opacity-50 italic text-[10px] uppercase tracking-widest">Loading products...</div>
            )}
          </div>
        </div>
      </section>
      ...
      <section className="py-12 bg-primary/5">
        <div className="container mx-auto px-4 max-w-2xl">
          <div className="glass p-8 rounded-2xl text-center border-primary/20 space-y-4 relative overflow-hidden">
             ...
             <h2 className="text-lg font-black uppercase italic tracking-tighter">Join the Hub</h2>
             <p className="text-muted-foreground uppercase text-[8px] tracking-widest font-bold">Get updates on new stock and special offers</p>
